...
export function ActiveUsersChart({ data, isLoading }: Props) {
  const { t } = useTranslation();
  const chartConfig = {
    count: {
      label: t('charts.activeUsers.label'),
  ...
  return (
    <StatChartCard
      title={t('charts.activeUsers.title')}
      description={t('charts.activeUsers.description')}
    >
      <ChartState
        isLoading={isLoading}
        isEmpty={isEmpty}
        emptyMessage={t('charts.activeUsers.empty')}
      >
